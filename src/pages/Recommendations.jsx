...
const ideas = [
  { symbol: 'AAPL', thesis: 'Ecosistema, servicios y capacidad de monetizar una base de usuarios global.', profile: 'Calidad', risk: 'Moderado', horizon: 'Largo plazo', tags: ['Tecnología', 'Calidad'], conviction: 'Alta' },
  { symbol: 'MSFT', thesis: 'Ingresos recurrentes y exposición a nube, software empresarial e inteligencia artificial.', profile: 'Crecimiento', risk: 'Moderado', horizon: 'Largo plazo', tags: ['Tecnología', 'Crecimiento'], conviction: 'Alta' },
  { symbol: 'GOOGL', thesis: 'Escala en publicidad y opcionalidad en nube e inteligencia artificial.', profile: 'Valor', risk: 'Moderado', horizon: 'Mediano plazo', tags: ['Tecnología', 'Valor'], conviction: 'Media' },
  { symbol: 'AMZN', thesis: 'AWS y logística aportan motores distintos, aunque el retail mantiene márgenes ajustados.', profile: 'Crecimiento', risk: 'Alto', horizon: 'Largo plazo', tags: ['Consumo', 'Crecimiento'], conviction: 'Media' },
  { symbol: 'TSLA', thesis: 'Potencial de movilidad eléctrica y energía, con elevada sensibilidad a competencia y ejecución.', profile: 'Crecimiento', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Automotriz', 'Crecimiento'], conviction: 'Baja' },
  { symbol: 'JPM', thesis: 'Escala, diversificación y franquicia bancaria para seguir el ciclo financiero.', profile: 'Valor', risk: 'Moderado', horizon: 'Mediano plazo', tags: ['Finanzas', 'Valor'], type: 'Acción', conviction: 'Media' },
  { symbol: 'NVDA', thesis: 'Exposición a infraestructura de inteligencia artificial, con valoración y competencia como riesgos principales.', profile: 'Crecimiento', risk: 'Alto', horizon: 'Largo plazo', tags: ['Tecnología', 'IA'], type: 'Acción', conviction: 'Media' },
  { symbol: 'JNJ', thesis: 'Negocio diversificado de salud y perfil defensivo, sujeto a litigios y regulación.', profile: 'Calidad', risk: 'Bajo', horizon: 'Largo plazo', tags: ['Salud', 'Defensiva'], type: 'Acción', conviction: 'Alta' },
  { symbol: 'XOM', thesis: 'Exposición a energía y generación de caja, con sensibilidad al precio del petróleo y transición energética.', profile: 'Valor', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Energía', 'Dividendos'], type: 'Acción', conviction: 'Media' },
  { symbol: 'AL30.BA', thesis: 'Bono soberano hard-dollar de referencia para analizar riesgo argentino, duration y paridad.', profile: 'Renta fija', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Argentina', 'Hard-dollar'], type: 'Bono', conviction: 'Media' },
  { symbol: 'GD30.BA', thesis: 'Bono global argentino emitido bajo ley extranjera; compará jurisdicción, paridad y vencimiento.', profile: 'Renta fija', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Argentina', 'Ley extranjera'], type: 'Bono', conviction: 'Media' },
  { symbol: 'TZX26.BA', thesis: 'Instrumento CER para estudiar cobertura frente a inflación, duration y riesgo de reinversión.', profile: 'Renta fija', risk: 'Moderado', horizon: 'Corto plazo', tags: ['Argentina', 'CER'], type: 'Bono', conviction: 'Alta' },
  { symbol: 'TX28.BA', thesis: 'Bono ajustable por CER con vencimiento posterior; evaluar inflación esperada, liquidez y tasa real.', profile: 'Renta fija', risk: 'Moderado', horizon: 'Mediano plazo', tags: ['Argentina', 'CER'], type: 'Bono', conviction: 'Media' },
  { symbol: 'YPF', thesis: 'ADR argentino vinculado a energía y Vaca Muerta; analizá producción, deuda, regulación y precio del petróleo.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Argentina', 'Energía'], type: 'ADR', conviction: 'Media' },
  { symbol: 'GGAL', thesis: 'ADR de Grupo Financiero Galicia; evaluar crecimiento del crédito, morosidad, regulación y exposición al ciclo argentino.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Argentina', 'Finanzas'], type: 'ADR', conviction: 'Media' },
  { symbol: 'PAM', thesis: 'ADR de Pampa Energía con exposición a electricidad, gas y generación; revisar regulación y precios de energía.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Largo plazo', tags: ['Argentina', 'Energía'], type: 'ADR', conviction: 'Media' },
  { symbol: 'TGS', thesis: 'ADR de Transportadora de Gas del Sur; estudiar tarifas, transporte de gas, inversiones y marco regulatorio.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Largo plazo', tags: ['Argentina', 'Gas'], type: 'ADR', conviction: 'Media' },
  { symbol: 'BMA', thesis: 'ADR de Banco Macro; comparar rentabilidad, liquidez, calidad de cartera y sensibilidad al ciclo local.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Mediano plazo', tags: ['Argentina', 'Finanzas'], type: 'ADR', conviction: 'Media' },
  { symbol: 'CRESY', thesis: 'ADR de Cresud con exposición agropecuaria e inmobiliaria; revisar precios de commodities, tierras y clima.', profile: 'ADR argentino', risk: 'Alto', horizon: 'Largo plazo', tags: ['Argentina', 'Agro'], type: 'ADR', conviction: 'Baja' }
]
...
const convictionClass = { Alta: 'text-emerald-300 bg-emerald-500/10 border-emerald-500/30', Media: 'text-amber-300 bg-amber-500/10 border-amber-500/30', Baja: 'text-slate-400 bg-slate-800 border-slate-700' }
const peers = {
...
export default function Recommendations() {
  ...
  return (
    <div className="max-w-[1250px] mx-auto px-4 lg:px-8 py-8">
      ...
      <div className="flex flex-wrap gap-2 mb-5" role="group" aria-label="Filtrar recomendaciones">{filters.map(item => <button type="button" key={item} aria-pressed={filter === item} onClick={() => setFilter(item)} className={`px-4 py-2 rounded-full text-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400 ${filter === item ? 'bg-cyan-400 text-slate-950 font-semibold' : 'bg-slate-800 text-slate-400 hover:text-white'}`}>{item}</button>)}</div>
      <section className="grid md:grid-cols-2 gap-4 mb-10">
        {filteredIdeas.map(idea => {
          ...
          const ideaPeers = idea.type === 'Bono' ? bondPeers.filter(symbol => symbol !== idea.symbol).slice(0, 3) : (peers[idea.symbol] || [])
          return <article key={idea.symbol} className="border border-slate-800 rounded-2xl bg-[#0c1422] p-5 hover:border-cyan-500/40 transition-colors">
            <div className="flex items-start justify-between gap-3"><div><span className="text-2xl font-semibold text-white">{idea.symbol}</span><p className="text-sm text-slate-500 mt-1">{idea.type} · {stock.company || 'Instrumento argentino'}</p></div><div className="flex flex-col items-end gap-1.5"><span className={`px-3 py-1 rounded-full text-xs font-semibold ${riskClass[idea.risk]}`}>Riesgo {idea.risk}</span><span className={`px-3 py-1 rounded-full text-xs font-semibold border ${convictionClass[idea.conviction] || convictionClass.Media}`}>Convicción {idea.conviction || 'N/D'}</span></div></div>
            ...
            <p className="text-xs text-slate-500 mt-2">Pares: {ideaPeers.length > 0 ? ideaPeers.join(', ') : 'Sin pares definidos'}</p>
            ...
            <button type="button" onClick={() => { setSelected({ ...idea, stock, upside }); setChecklist({}) }} className="w-full mt-5 py-2.5 rounded-lg bg-slate-800 text-slate-300 hover:bg-cyan-500 hover:text-slate-950 font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400">Ver tesis y checklist de {idea.symbol}</button>
          </article>
        })}
      </section>

      {selected && <section aria-label={`Evaluación guiada de ${selected.symbol}`} className="border border-cyan-500/30 rounded-2xl bg-cyan-500/5 p-6 mb-10">
        <div className="flex justify-between items-start"><div><p className="text-xs uppercase tracking-wider text-cyan-300">Evaluación guiada · {selected.type}</p><h3 className="text-2xl text-white font-semibold mt-2">{selected.symbol} · {selected.profile}</h3></div><button type="button" onClick={() => setSelected(null)} aria-label={`Cerrar evaluación de ${selected.symbol}`} className="text-slate-400 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-cyan-400 rounded">×</button></div>
